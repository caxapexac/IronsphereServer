...
namespace unit_testing {
    void test_tilemap_square() {
        ...
        json j;
        //
        abstract_tilemap* t_square = new tilemap_square(vector2<int>(1, 2));
        ...
        std::cout << j.dump(2) << std::endl;
        //
        t_square->set_tile(vector2<int>(1, 2), new tile_damage(0.5f, 2));
        t_square->set_tile(vector2<int>(2, 2), new tile_money(0.5f, 20));
        j = {};
        t_square->serialize(j);
        std::cout << j.dump(2) << std::endl;
        //
