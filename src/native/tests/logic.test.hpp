...
namespace unit_testing {
    void test_logic() {
        ...
        while (true) {
            ...
            if (game->get_unit(4)) std::cout << "Object 4 has " << game->get_unit(4)->get_parameter<float>(com::j_mortal::hp) << " HP and "  <<
                    game->get_unit(4)->get_parameter<float>(com::j_mortal::armor) << " armor left." << std::endl;
            else std::cout << "Object 4 has died." << std::endl;
